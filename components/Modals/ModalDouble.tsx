...
const ModalDouble: React.FC<Props> = ({
    ...
    const renderFooter = () => {
        ...
        return (
            <div className={styles.footer}>
                ...
                <ButtonSmall text={action2.label} onClick={action2.action} extraStyles={{ width: '30%' }} color="blue" />
            </div>
        );
    };
    ...
    const modalBackgroundClass = modalBlack ? styles.modalBackgroundSecondary : styles.modalBackground;
    ...
    return (
        <>
            ...
            <div
                className={`${styles.ModalDouble} ${isClosing ? styles.closing : ''} ${visibleSecondModal ? styles.active : ''
                    }`}
                style={extraStyles}
            >
